function [zk,vk,temp1,temp2,temp1a,temp1b,cellLamW,vsloc]=krigingME2_correct(ck,ch,cs,zh,zs,vs,covmodel,covparam,nhmax,nsmax,dmax,order,options);
...
cellLamW = cell(nk,1); % added 9/30/2014
vsloc = cell(nk,1); % added 10/6/2014
...
%     disp(i);
  ...
  if (sumnhlocal+sumnslocal)>0,                        % if there is at least one hard or soft data
    ...
    cellLamW{i} = newweight; % added 9/30/2014
